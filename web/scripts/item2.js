...
function photo(datas, id, buttonID, mode) {
    ...
    var title_span = document.createElement("label");
    title_span.className = "layui-form-label";
    ...
    var photo_span = document.createElement("label");
    photo_span.className = "layui-form-label";
...
function question(datas, id, buttonID, mode) {
    ...
    var context_span = document.createElement("label");
    context_span.className = "layui-form-label";
    ...
    for (var i = 0; i < options.length; i++) {
        (function(i){
            ...
            var option_span = document.createElement("label");
            option_span.className = "layui-form-label";
    ...
    var text = document.createElement("label");
    text.className = "layui-form-label";
    text.innerHTML = "获得分数";
...
function video(datas, id, buttonID, mode) {
    ...
    video_div.setAttribute("controls", "ture");
    ...
    var video_span = document.createElement("label");
    video_span.className = "layui-form-label";
